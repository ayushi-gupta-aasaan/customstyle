...
const Software = props => (
  <Svg viewBox="0 0 40 40" width="1em" height="1em" {...props}>
    <G fill={props.color} stroke="#1A4266" strokeWidth={0.2}>
      ...
      <Path d="M18.267 20.264l2.336-8.162 1.121.32-2.336 8.163zm-1.394-6.399l-.746-.896-3.5 2.916a.583.583 0 0 0 0 .896l3.5 2.917.746-.896-2.962-2.469 2.962-2.468zm10.575 2.095a.583.583 0 0 0-.075-.075l-3.5-2.916-.746.896 2.962 2.468-2.962 2.469.746.896 3.5-2.917a.583.583 0 0 0 .075-.821z" />
    </G>
  </Svg>
);
